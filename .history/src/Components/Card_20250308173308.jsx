...
function Card({ width = "sm:w-[18vw]", height = "sm:h-[30vh]", name, bgImage }) {
  ...
  return (
    ...
    <motion.div
      ...
      <footer className="absolute bottom-0 left-0 right-0 flex gap-2 p-2 sm:opacity-0 sm:translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
