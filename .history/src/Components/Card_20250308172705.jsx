...
function Card({ width = "h-18", height = "h-30", name,smhw="h-40 w-60", bgImage }) {
  ...
  return (
    <motion.div
      ...
      style={{  
       ...
       className={`relative card group bg-amber-300 overflow-hidden rounded-lg  ${width} ${height} ${smhw}`}
    >
