...
function App() {
  return (
    <div className=''>
      ...
      <div className='hero sm:p-7 sm:text-5xl text-[8vw] w-[80vw] sm:w-[47vw]'>
      <logo className='text-4xl sm:text-5xl font-semibold'>hitoutvrma</logo>
        ...
        <div style={{ backgroundImage: "url('/user.jpg')" }} className='sm:ml-[10vw] bg-cover bg-center w-[43vw] h-[92vh]  bg-[#3a3a3a] rounded-md'>          
        </div>
      </div>
