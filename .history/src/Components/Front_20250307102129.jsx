    ...
    <div className="sm:flex">
      ...
      <logo className='text-4xl sm:text-5xl font-semibold font-[serif]'>hitoutvrma</logo>
        ...
        <div className='flex sm:text-[2vh] sm:pb-0 pb-12 text-[1.8vh]  sm:pt-23 pt-28 flex-col sm:gap-3 gap-1'>
          ...
          <motion.div whileHover={{scaleX: 1.1}} transition={{duration:3}} style={{originX:0}}  className='w-[90%]  font-bold '>Twitter/X</motion.div>
          <motion.div className='w-[90%]  h-[0.1vh] bg-[#8c8c8c]'></motion.div.div>
