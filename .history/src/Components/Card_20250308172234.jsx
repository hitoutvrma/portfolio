...
function Card({ width = 18, height = 30, name, bgImage }) {
  ...
  return (
    <motion.div
      ...
      className=<div className={`relative card group group-hover:backdrop-blur-2xl overflow-hidden rounded-lg ${width} ${height}`}>
    >
