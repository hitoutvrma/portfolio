  ...
  return (
    <div className='h-auto min-h-screen sm:p-5 '>
      ...
      <div className='flex gap-8 pb-5'>
        <div onClick={()=>setCurrent()} className='py-1 px-2 bg-gray-400 text-black rounded-sm'>React</div><div className='py-1 px-2 bg-gray-400 text-black rounded-sm'>Nodejs</div>
