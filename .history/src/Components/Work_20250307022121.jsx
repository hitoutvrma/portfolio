      ...
      <div>
        <div className="bg-green-900 relative h-90 sm:h-70 sm:w-70 w-90 card">
            ...
            <footer className='bottom-0  absolute'>
                <button className='m-2 px-1 py-1 backdrop-blur-xl bg-white/30   text-[1.5vh] '>Web</button>
                <button className='m-2 px-1 py-1 backdrop-blur-xl bg-white/30  text-[1.5vh] '>React</button>
                </footer>
        </div>
      </div>
    </div>
