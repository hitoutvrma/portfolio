...
const CursorImagePop = () => {
    ...
    return (
        <div className="relative bg-amber-600 flex justify-center items-center" style={{ height: "100vh", backgroundColor: "black", overflow: "hidden" }}>
            <h1 className="text-4xl">as;dfasjdkfl;</h1>
            {positions.map((img) => (
                <img
                    key={img.id}
                    src={img.src}
