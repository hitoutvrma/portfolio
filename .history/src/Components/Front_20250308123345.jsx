  ...
  return (
    ...
    <div className="sm:flex">
      ...
      >
        ...
        <motion.div on={{scale:2}} initial={{opacity:0,scale:0.9}} transition={{duration:3, delay:1.5}} animate={{opacity:1,scale:1}} style={{ backgroundImage: "url('/user.jpg')" }} className='bg-cover sm:bg-[center_top_60%] bg-[center_top_80%] w-[95%] h-[50vh] sm:w-[43vw] sm:h-[92vh]  bg-[#3a3a3a] rounded-md'>          
        </motion.div>
