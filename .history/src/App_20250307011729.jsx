    ...
    <div className=''>
      ...
      <logo className='text-4xl sm:text-5xl font-semibold'>hitoutvrma</logo>
        ...
        <div className='flex flex-col gap-2'>
          <p>CONNECT</p>
          <div className='w-[90%] bg-gray-800'>Twitter/X</div>
          <div className='w-[90%] h-[0.1vh] bg-amber-500'></div>
          <div className='w-[90%] bg-gray-800'>Instagram</div>
          <div className='w-[90%] h-[0.1vh] bg-amber-500'></div>
          <div className='w-[90%] bg-gray-800'>Linkedin</div>
          <div className='w-[90%] h-[0.1vh] bg-amber-500'></div>
          <div className='w-[90%] bg-gray-800'>Email</div>
          <div className='w-[90%] h-[0.1vh] bg-amber-500'></div>
        </div>
        </div>
