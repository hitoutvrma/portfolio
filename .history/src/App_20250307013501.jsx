...
function App() {
  return (
    <div className=''>
      ...
      <div className='hero sm:p-7 sm:text-[2.5vw] text-[8vw]  sm:w-[53vw]'>
      <logo className='text-4xl sm:text-5xl font-semibold'>hitoutvrma</logo>
        ...
        <div className='flex sm:text-[2vh] sm:pb-0 pb-12 text-[1.8vh] sm:pt-32 pt-28 flex-col sm:gap-3 gap-1'>
