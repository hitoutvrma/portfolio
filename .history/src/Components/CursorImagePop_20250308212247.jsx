...
const CursorImagePop = () => {
    ...
    return (
        ...
        <div onMouseMove={""} className='h-screen opacity-1000 sm:p-5 flex flex-col justify-center items-center'>
        <div className="bg-black flex items-center justify-center flex flex-col gap-4" >
