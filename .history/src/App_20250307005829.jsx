  ...
  return (
    <div className=''>
      ...
      <logo className='text-4xl sm:text-5xl font-semibold'>HITESH</logo>
        <p className='mt-28 text-[#8c8c8c]'><span className='font-semibold'>Hitesh Verma</span> is an award-winning multidisciplinary digital web developer based in India</p>
        </div>
