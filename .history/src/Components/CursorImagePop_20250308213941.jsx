...
const CursorImagePop = () => {
    ...
    return (
        ...
        <div onMouseMove={""} className='h-screen z-50 opacity-1000 sm:p-5 flex flex-col justify-center items-center'>
        <div className=" flex items-center justify-center  flex-col gap-4" >
      <p className="sm:text-5xl text-3xl text-white opacity-150 text-center font-bold">
        Interested In Working Together?
        </p>
      <button onClick={} className="px-2 py-1 text-lg font-bold  bg-white text-black hover:bg-pink-200 cursor-pointer transition-colors duration-300 rounded-md ">Email Me</button>
        </div>
