...
function Card({ width = 18, height = 30, name }) {
  ...
  return (
    ...
    >
      ...
      <h1 className="absolute top-2 left-2 text-white text-[1.9vh] opacity-0 translate-y-[-] transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
        {name}
      </h1>
