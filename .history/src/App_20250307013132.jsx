...
function App() {
  return (
    <div className=''>
      ...
      <div className='hero sm:p-7 sm:text-5xl text-[8vw]  sm:w-[53vw]'>
      <logo className='text-4xl sm:text-5xl font-semibold'>hitoutvrma</logo>
        ...
        <div style={{ backgroundImage: "url('/user.jpg')" }} className=' pt-10 bg-cover sm:bg-center bg-[center_top_80%] w-[95%] h-[50vh] sm:w-[43vw] sm:h-[92vh]  bg-[#3a3a3a] rounded-md'>          
        </div>
      </div>
