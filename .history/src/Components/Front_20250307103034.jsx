    ...
    <div className="sm:flex">
      ...
      <logo className='text-4xl sm:text-5xl font-semibold font-[serif]'>hitoutvrma</logo>
        ...
        <div className='flex sm:text-[2vh] sm:pb-0 pb-12 text-[1.8vh]  sm:pt-23 pt-28 flex-col sm:gap-3 gap-1'>
          ...
          <motion.div<p className="text-white text-3xl font-bold cursor-pointer">Twitter</p>
        
        {/* Static Gray Line */}
        <div className="absolute left-0 bottom-0 w-full h-[2px] bg-gray-500 opacity-50"></div>
