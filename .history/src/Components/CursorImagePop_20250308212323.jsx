...
const CursorImagePop = () => {
    ...
    return (
        ...
        <div className="opacity-50 h-screen overflow-hidden ">
            {/* Floating Images */}
            {positions.map((img) => (
                <img
                key={img.id}
        ...
        <div onMouseMove={""} className='h-screen z-100 opacity-1000 sm:p-5 flex flex-col justify-center items-center'>
        <div className=" flex items-center justify-center bg-amber-300 flex flex-col gap-4" >
