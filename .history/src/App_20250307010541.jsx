...
function App() {
  return (
    <div className=''>
      ...
      <div className='hero sm:p-7 sm:text-5xl text-[7.7vw] w-[80vw] sm:w-[40vw]'>
      <logo className='text-4xl sm:text-5xl font-semibold'>hitoutvrma</logo>
        <p className='mt-28 leading-0 text-[#8c8c8c]'><span className='text-white font-semibold'>Hitesh Verma</span> is an award-winning multidisciplinary digital web developer based in India</p>
