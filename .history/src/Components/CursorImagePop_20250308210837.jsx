...
const CursorImagePop = () => {
    ...
    return (
        <div className="relative flex justify-center  items-center" style={{ height: "100vh",opacity:0.5, overflow: "hidden" }}>
            <div className="absolute z-120 bg-amber-300 text-4xl opacity-1000 ">as;dfasjdkfl;</div>
            {positions.map((img) => (
                <img
                    key={img.id}
                    src={img.src}
                    alt=""
                    className="pop-image opacity-100"
                    style={{
                        position: "absolute",
                        width: "260px",
                        height: "auto",
