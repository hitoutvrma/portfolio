  ...
  return (
    ...
    <div className="sm:flex">
      ...
      >
        ...
        <motion.div initial={{scale:0.4}} transition={{duration:2}} animate={{scale:1}} style={{ backgroundImage: "url('/user.jpg')" }} className='bg-cover sm:bg-[center_top_60%] bg-[center_top_80%] w-[95%] h-[50vh] sm:w-[43vw] sm:h-[92vh]  bg-[#3a3a3a] rounded-md'>          
        </motion.div>
      </div>
        </div>
  )
