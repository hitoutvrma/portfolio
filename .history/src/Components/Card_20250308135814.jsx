...
function Card({ width = 18, height = 30, name }) {
  ...
  return (
    <motion.div
      ...
      className="bg-green-900 relative card group overflow-hidden rounded-lg"
    >
      {/* Name (Hidden initially, appears on hover) */}
      <h1 className="absolute top-2 left-2 text-white text-[1.9vh] opacity-0 translate-y-[-10] transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
        {name}
      </h1>
