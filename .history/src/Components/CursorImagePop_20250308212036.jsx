...
const CursorImagePop = () => {
    ...
    return (
        ...
        <div className="opacity-30 h-screen overflow-hidden ">
            {/* Floating Images */}
            {positions.map((img) => (
                <img
                key={img.id}
        ...
        <div className='h-screen opacity-1000 sm:p-5 flex flex-col justify-center items-center'>
        <div className="flex items-center justify-center flex flex-col gap-4" >
      <p className="sm:text-5xl text-3xl text-yellow-700 opacity-150 text-center font-bold">
