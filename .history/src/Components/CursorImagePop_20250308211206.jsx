...
const CursorImagePop = () => {
    ...
    return (
        <div className="relative flex justify-center items-center" style={{ height: "100vh", overflow: "hidden" }}>
            ...
            <div className="absolute inset-0 bg-black opacity-120"></div>

            {/* Center Div (Fully Opaque) */}
            <div className="absolute z-10 bg-amber-300 text-4xl px-6 py-4 rounded-lg shadow-lg">
                as;dfasjdkfl;
            </div>
