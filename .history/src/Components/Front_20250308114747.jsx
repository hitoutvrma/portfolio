  ...
  return (
    ...
    <div className="sm:flex">
      ...
      <logo className='text-4xl sm:text-5xl font-semibold font-[serif]'>hitoutvrma</logo>
        ...
        <motion.div initial={{opacity:0, scaleY:0.5}} animate={{opacity:1, scaleY:1}} transition={{duration:2, delay:1.2}} className=' flex sm:text-[2vh] sm:pb-0 pb-12 text-[1.8vh]  sm:pt-25 pt-28 flex-col sm:gap-3 gap-1'>
