    ...
    <div className="sm:flex">
      ...
      <logo className='text-4xl sm:text-5xl font-semibold font-[serif]'>hitoutvrma</logo>
        ...
        <div className='flex sm:text-[2vh] sm:pb-0 pb-12 text-[1.8vh]  sm:pt-23 pt-28 flex-col sm:gap-3 gap-1'>
          ...
          <motion.div   className='w-[90%]  font-bold '>Twitter/X</motion.div>
          ...
          <motion.div
  className="relative w-[200px] h-[50px] flex items-center justify-center text-white font-bold"
  whileHover="hovered"
>
  <motion.div
    ...
    variants={{
      hovered: { backgroundPositionX: "100%" },
    }}
    transition={{ duration: 1, ease: "linear" }}
    style={{
      backgroundImage: "linear-gradient(90deg, red, blue, green)",
